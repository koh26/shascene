...
### サイト全体のデザイン
想い出を投稿してもらうアプリケーションなので、淡い、儚い感じを演出するためhoverの色を暖色系を使用し、文字なども透過させています。  
また投稿が多くなってし深くスクロールすることになっても、すぐにトップページやマイページに遷移できるようにヘッターを固定しています。
...
### 投稿マップの追加
目的: 宮城のみだけでなく、他の震災の被害にあった県も同様に投稿をできるようにするため。
詳細: 岩手、福島などの県マップに市町村ごとで投稿できるようにリンクを設定する。
